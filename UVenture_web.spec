...
a = Analysis(
    ...
    hiddenimports=['scipy.stats._distn_infrastructure',
               ...
               'scipy.linalg',
               'scipy.sparse',
               'scipy._lib', 'scipy', 'matplotlib', 'importlib', 'importlib._bootstrap', 'scipy.signal._peak_finding', 'scipy.stats._distn_infrastructure', 'scipy.special._ufuncs', 'scipy.stats', 'scipy.signal', 'scipy.stats.distributions', 'scipy.stats._stats_py', 'scipy.signal._savitzky_golay'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=['PyQt5'],
